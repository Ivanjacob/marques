...
import { fetchFarmers } from '../utils/stockAxios';
...
function Farmers(){
    ...
    const columns = [
        ...
        //     ),
        // },
        {field: 'farmer_id', headerName: "Farmer's Id", width: 100},
        {field: 'rice_stored', headerName: 'Rice Stored', width: 160, valueGetter: (params) => `${params.value}   KGs.`}, // ValueGetter is used to add KSh. sign to price
    ]
    ...
    return(
        ...
        <div style={{ margin: "2rem", marginTop: "2rem", padding: "0.5rem",  backgroundColor: "#fff", borderRadius: "1.5rem", }}>
            ...
            >
                ...
                <Header category="Page" title="Farmers" />
                <Button 
