  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newQuantityInStock =
        parseInt(currentStock.quantity_in_stock) + parseInt(receive_stock);
      ...
      swal.fire({
        title: "Success",
        text: "Product Stock Received Successfully",
        icon: "success",
        toast: true,
        timer: 3000,
        position: "top",
        ...
        customClass: {
          container: "green-alert", // Apply your custom class here
        },
      });
